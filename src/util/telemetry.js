...
const BaseTypes = {
  ...
  NodeIO: {
    name: 'NodeIO',
    fields: ['Bytes', 'Bytes', 'BytesPerSecond', 'BytesPerSecond']
  },
  NodeHardware: {
    name: 'NodeHardware',
    fields: [
...
const Types = {
  ...
  BestBlock: {
    name: 'BestBlock',
    fields: ['BlockNumber', 'Timestamp', 'Milliseconds']
  },
  BestFinalized: {
    name: 'BestFinalized',
  ...
  AddedNode: {
    ...
    fields: [
      'NodeId',
      BaseTypes.NodeDetails,
      BaseTypes.NodeStats,
      BaseTypes.NodeIO,
      BaseTypes.NodeHardware,
      BaseTypes.BlockDetails,
      BaseTypes.NodeLocation,
      'Timestamp'
    ]
  },
  ...
  LocatedNode: {
    name: 'LocatedNode',
    fields: ['NodeId', 'Latitude', 'Longitude', 'City']
  },
  ImportedBlock: {
    name: 'ImportedBlock',
    fields: ['NodeId', BaseTypes.BlockDetails]
  },
  FinalizedBlock: {
    name: 'FinalizedBlock',
    fields: ['NodeId', 'BlockNumber', 'BlockHash']
  },
  NodeStats: { name: 'NodeStats', fields: ['NodeId', BaseTypes.NodeStats] },
  NodeHardware: {
    name: 'NodeHardware',
    fields: [null, BaseTypes.NodeHardware]
  },
  ...
  AfgReceivedPrevote: {
    name: 'AfgReceivedPrevote',
    fields: ['Address', 'BlockNumber', 'BlockHash']
  },
  AfgReceivedPrecommit: {
    name: 'AfgReceivedPrecommit',
    fields: ['Address', 'BlockNumber', 'BlockHash']
  },
